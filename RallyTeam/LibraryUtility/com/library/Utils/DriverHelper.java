...
public abstract class  DriverHelper extends DriverTestCase {
   ...
   public void enterValueIntoTextField(String locator, String value){
	...
	public static String getSystemTime() {
		Date date = new Date();
		String Systemtime = String.valueOf(date.getTime());
		return Systemtime;
	}
	/**
	 * get the current time of the system
	...
	public static String getSystemTimeSeconds() {
		...
		String Timenow=second+Minute+Hours;
		return Timenow;
	}
	...
	public void scrollIntoView(By by) {
		...
		((JavascriptExecutor) driver).executeScript(
				"arguments[0].scrollIntoView(true);", new Object[] { elem });
	}
